...
while True:
    ...
    for posicao, c in enumerate(secret_word): #Vai percorrer a string secret_word
        ...
        if c == letra: #Se a letra da palavra secreta for igual a letra que o usuario digitou
            ...
            cripto_word_list[posicao] = c # E se a letra for correta o item lista criptografada vira a letra
            trys_list.remove(c) #Se a letra for correta ele remove a letra correta da lista de tentativa
            for cd_letra in cripto_word_list: #Para cada letra da lista criptografada
                print(cd_letra, end=' ') #Ele vai printar a letra e tirar a quebra de linha
